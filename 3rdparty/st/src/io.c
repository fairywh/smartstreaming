...
static __thread int _st_osfd_limit = -1;
...
static _st_netfd_t *_st_netfd_new_only(int osfd, int nonblock, int is_socket)
{
  _st_netfd_t *fd;
  int flags = 1;
...
_st_netfd_t *st_netfd_open_socket_only(int osfd)
{
  return _st_netfd_new_only(osfd, 1, 1);
}
